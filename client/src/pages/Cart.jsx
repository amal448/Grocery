...
const Cart = () => {
    ...
    const [showAddress, setShowAddress] = useState(false)    /* trigger for hide and show */
    const { products, currency, cartItems, axios, user, removeFromCart, getCartCount, updateCartItem,
        navigate, getCartAmount,setCartItems } = useAppContext()
