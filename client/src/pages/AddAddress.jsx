                ...
                <div className='flex-1 max-w-md'>
                    <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                        <div className='grid grid-cols-2 gap-4'>
                            <InputField type="text" placeholder="FirstName" name='firstName' handleChange={handleChange} address={address} />
                            <InputField type="text" placeholder="LastName" name='lastName' handleChange={handleChange} address={address} />
                        </div>
                        ...
                        <div className='grid grid-cols-2 gap-4'>
                            <InputField type="number" placeholder="zipcode" name='zipcode' handleChange={handleChange} address={address} />
