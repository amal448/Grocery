        ...
        <div className='relative'>
            ...
            justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
                <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left max-w-72
                 md:max-w-80 lg:max-w-105 leading-tight lg:leading-14'>Freshness You Can Trust,Savings You will Love !</h1>
                ...
                <div className='flex items-center mt-6 font-medium'>
                 ...
                 bg-primary  hover:bg-primary-dull transition rounded text-white cursor-pointer'>
                    ...
                    <Link to={'/products'} className='group hidden md:flex items-center gap-2 px-3 cursor-pointer'>
                        Explore Deals
