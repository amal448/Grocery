...
const ProductCard = ({ product }) => {
    ...
    const { currency, cartItems, addToCart, updateCartItem,
    removeFromCart, navigate } = useAppContext()
            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-center gap-0.5">
                    {Array(5).fill('').map((_, i) => (
                        <img key={i} src={i < 4 ? assets.star_icon : assets.star_dull_icon} className='md:w-3.5 w-3 ' alt='' />
